...
final class Output
{
     ...
     * @return mixed|string
     */
    public static function post($url, array $params = [], $autoVal = '')
    {
        return self::send($url, $params, 'post', $autoVal);
    }
     ...
     * @return mixed|string
     */
    public static function get($url, array $params = [], $autoVal = '')
    {
        return self::send($url, $params, 'get', $autoVal);
    }
     ...
     */
    public static function send($url, array $data = [], $type = 'post', $autoVal = '', $cert = null)
    {
