...
class Password
{
     ...
     * @return string
     */
    public static function md3(string $str, $double = false)
    {
...
//        echo "原生MD5={$md}[{$len}]='" . $md[$len] . "'的asc(" . $md[$len] . ")=" . ord($md[$len]) . "，取5模={$i}字典】";
    ...
    public static function md3_verify($string, $password):bool
    {
     ...
     */
    public static function md4_verify($string, $password):bool
    {
     ...
     * @return string
     */
    public static function base_en($String, int $expiration = 0)
    {
        //创建时间，内容，有效时间
     ...
     * @return string
     */
    private static function str_conversion(int $od, int $ai = 0, bool $en = true, int $Hex = 36, int $pdLen = 4)
    {
     ...
     * @return string
     */
    public static function int_en(int $int)
    {
        $ordS = [];//换取ASC值
     ...
     * @return int
     */
    public static function int_de(int $int)
    {
        $eS = str_split($int, 4);
        $ascS = [];
    ...
    private static function int_conversion($str, int $ai = 0, bool $en = true)
    {
        //转换因子，将0-9打乱即可
     ...
     * @return string
     */
    public static function str_rand(int $min = 0, int $max = 0)
    {
