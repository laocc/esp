...
class Image
{
     ...
     * @return bool
     */
    public static function limit(string $file, array $size = [0, 0], $backUP = true)
    {
     ...
     * @return bool
     */
    public static function size(string $file, array $reSize = [0, 0], $backUP = true)
    {
        if (!is_file($file)) return false;
        $info = getimagesize($file);
        if (!$info) {
     ...
     * @return bool
     */
    public static function convert(string $file, string $toExt, $fromExt = null)
    {
        if (!is_file($file)) {
     ...
     * @return bool
     */
    public static function thumbs_tclip(string $file, array $option = [])
    {
     ...
     * @return bool
     */
    public static function mark(string $picFile, array $config)
    {
     ...
     * @return bool
     */
    private static function Mark_Create(string $fileName, array $img, array $txt, $order = 1)
    {
        //是否加水印
